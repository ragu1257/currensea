export const currencies = [
  ...
  { value: 'CNY', label: 'CNY - Chinese Yuan', imgURL: "/assets/china-icon.png", symbol: "¥"},
  { value: 'SEK', label: 'SEK - Swedish Krona', imgURL: "/assets/sweden-icon.png", symbol: "kr"},
  { value: 'NZD', label: 'NZD - New Zealand Dollar', imgURL: "/assets/new-zealand-icon.png", symbol: "$"},
  { value: 'MXN', label: 'MXN - Mexican Peso', imgURL: "/assets/mexico-icon.png", symbol: "$"},
  { value: "INR", label: "INR - Indian Rupee", imgURL: "/assets/india-icon.png", symbol: "₹"},
]